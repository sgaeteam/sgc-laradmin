...
@section('htmlheader_title')
	Visualizar &Aacute;reas de Compet&ecirc;ncias
@endsection
...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $area_competencia->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Area_Competencias", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/area_competencias/'.$area_competencia->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Area_Competencias", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.area_competencias.destroy', $area_competencia->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/area_competencias') }}" data-toggle="tooltip" data-placement="right" title="Voltar para &Aacute;reas de Compet&ecirc;ncias"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					<div class="panel-default panel-heading">
						<h4Informa&ccedil;&otilde;es Gerais</h4>
					</div>
					<div class="panel-body">
						@la_display($module, 'sigla')
