...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/agendas') }}" data-toggle="tooltip" data-placement="right" title="Voltar para Agendas"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'data_inicio')
						@la_display($module, 'data_termino')
						@la_display($module, 'espaco_id')
						@la_display($module, 'reserva_id')
					</div>
				</div>
			</div>
		</div>
